...
### <span class="section-num">4.2</span> 테스트 ID 로그인 {#테스트-id-로그인}
...
## <span class="section-num">6</span> step-4 일반회원대여 화면 만들기 {#step-4-일반회원대여-화면-만들기}
...
## <span class="section-num">7</span> step-5 관리자 화면 만들기 {#step-5-관리자-화면-만들기}
...
### <span class="section-num">8.1</span> 마이페이지 만들기 {#마이페이지-만들기}
...
### <span class="section-num">8.2</span> 대여신청화면 수정 {#대여신청화면-수정}
...
### <span class="section-num">8.3</span> 마이페이지 수정 {#마이페이지-수정}
...
### <span class="section-num">8.4</span> 체크포인트 링크 {#체크포인트-링크}
...
## <span class="section-num">9</span> step-7 관리자화면 개선 {#step-7-관리자화면-개선}


### <span class="section-num">9.1</span> 화면 구성변경 {#화면-구성변경}
...
### <span class="section-num">9.2</span> 장비목록 관리 {#장비목록-관리}
...
### <span class="section-num">9.4</span> 체크포인트 {#체크포인트}
